...
if __name__ == "__main__":
    print("🧪 Running QVPIC v10.2 full integration pipeline (RubikCone + ShellCube)")
    # ... everything that was previously at module level stays exactly as-is
    # (the parser, conduit init, bake_facts(), drift_test(), etc.)